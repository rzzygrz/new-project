...
- **Cursor IDE** — primary editor and AI-assisted development environment  
- **Codex extension (in Cursor)** — OpenAI Codex integration inside Cursor  
- **Claude Code extension (in Cursor)** — Anthropic Claude integration inside Cursor  
- **GitHub Desktop** — Git GUI for commits, branches, and syncing with GitHub  
...
- ✅ Installed and signed in to the Claude Code and Codex extensions  
- ✅ Created a GitHub repository  
- ✅ Opened the repository in Cursor  
- ✅ Created this **README.md** so it describes:  
